...
<!-- Hero Section -->
<section
  class="relative py-32 px-6 overflow-hidden bg-gradient-to-br from-gray-50 via-white to-cyan-50"
>
  <!-- Animated Background -->
  ...
  <div
    class="container mx-auto max-w-4xl text-center"
    in:fly={{ y: 20, duration: 500 }}
  >
    <!-- Badge -->
    <div
      class="inline-flex items-center gap-2 px-5 py-2.5 mb-8 bg-gradient-to-r from-cyan-500/15 to-violet-500/15 backdrop-blur-sm border border-cyan-500/30 rounded-full text-sm font-medium shadow-lg"
    >
    ...
    >
      Artigos sobre desenvolvimento web, tecnologia e inovação. Fique por dentro
