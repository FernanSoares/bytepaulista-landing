...
<div class="min-h-screen bg-gradient-to-br from-gray-50 via-white to-cyan-50">
	...
	<article class="pb-20">
		<div class="container mx-auto max-w-4xl px-6">
			...
			<!-- Footer -->
			<footer class="mt-16 pt-8 border-t border-gray-200" in:fly={{ y: 20, duration: 500, delay: 400 }}>
				<div class="bg-gradient-to-r from-cyan-50 to-violet-50 rounded-2xl p-8 border border-cyan-100">
