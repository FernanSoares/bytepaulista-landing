...
<!-- Back Button -->
<div class="container mx-auto max-w-4xl px-6 pt-32 bg-gradient-to-br from-gray-50 via-white to-cyan-50">
	<a
		href="/blog"
...
<!-- Article -->
<article class="container mx-auto max-w-4xl px-6 pb-20 bg-gradient-to-br from-gray-50 via-white to-cyan-50">
	<!-- Header -->
